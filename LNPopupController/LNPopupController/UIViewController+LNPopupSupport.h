...
- (void)presentPopupBarWithContentViewController:(UIViewController*)controller animated:(BOOL)animated completion:( void(^)())completion;
 ...
 */
- (void)openPopupAnimated:(BOOL)animated completion:( void(^)())completion;
 ...
 */
- (void)closePopupAnimated:(BOOL)animated completion:( void(^)())completion;
 ...
 */
- (void)dismissPopupBarAnimated:(BOOL)animated completion:( void(^)())completion;
 ...
 */
@property ( nonatomic, strong, readonly) LNObjectOfKind(UIViewController*) popupContentViewController;
 ...
 */
@property ( nonatomic, weak, readonly) LNObjectOfKind(UIViewController*) popupPresentationContainerViewController;
